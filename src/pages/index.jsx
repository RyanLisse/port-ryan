...
function Resume() {
  let resume = [
    {
      company: 'VMCA',
      title: 'PR & Communications coördinator',
      logo: logoVMCA,
      start: '2021',
      end: {
        label: '2022',
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I’m Ryan Lisse, a software designer and entrepreneur based in Almere, The netherlands. I’m the founder and CEO of Reject Sound, where we develop technologies that empower regular people to explore space on their own terms."
        />
      </Head>
